...
class App extends JFrame implements ItemListener{
	...
	public void itemStateChanged(ItemEvent ie) {
		...
		if(textOnButton.equals("Red")) {
			messageContainer.setBackground(Color.RED);
			lightsContainer.setBackground(Color.RED);
			message.setText("STOP");
		} else if(textOnButton.equals("Yellow")) {
			messageContainer.setBackground(Color.YELLOW);
			lightsContainer.setBackground(Color.YELLOW);
			message.setText("READY");
		} else {
			messageContainer.setBackground(Color.GREEN);
			lightsContainer.setBackground(Color.GREEN);
			message.setText("GO");
		}
	}
}
